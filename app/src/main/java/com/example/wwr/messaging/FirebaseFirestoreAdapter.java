...
public class FirebaseFirestoreAdapter implements MessageService {
    ...
    @Override
    public void subscribeToMessages(Consumer<List<Message>> listener) {
                ...
                .addSnapshotListener((newChatSnapShot, error) -> {
                    ...
                    if (newChatSnapShot != null && !newChatSnapShot.isEmpty()) {
                        ...
                        List<Message> newMessages = documentChanges.stream()
                                ...
                                .map(doc -> new Message(doc.getString(fromKey), doc.getString(textKey)))
