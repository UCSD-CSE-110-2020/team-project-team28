        ...
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.enter_name),
                        childAtPosition(
                                ...
                                6),
                        isDisplayed()));
        appCompatEditText.perform(replaceText("Karen"), closeSoftKeyboard());
                ...
                allOf(withId(R.id.routeNamePage),
                        childAtPosition(
                                childAtPosition(
                                        ...
                                        0),
                                2)));
        appCompatEditText5.perform(scrollTo(), replaceText("Name"), closeSoftKeyboard());
                ...
                allOf(withId(R.id.startLocationName),
                        childAtPosition(
                                childAtPosition(
                                        ...
                                        0),
                                1)));
        appCompatEditText6.perform(scrollTo(), replaceText("Loc"), closeSoftKeyboard());
