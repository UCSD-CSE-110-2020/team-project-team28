...
public class Scenario12Test {
    ...
    /*    ViewInteraction appCompatButton7w = onView(
        ...
        ViewInteraction appCompatRadioButtonq2 = onView(
                allOf(withId(R.id.edit_proposed_walk_button),
                        isDisplayed()));
        appCompatRadioButtonq2.perform(click());


        //edit and schedule walk

        ViewInteraction appCompatEditText7e2 = onView(
                allOf(withId(R.id.propose_walk_time), withText("Propose Time"),
                        isDisplayed()));
        appCompatEditText7e2.perform(replaceText("1:00"));

        ViewInteraction appCompatEditText8e2 = onView(
                allOf(withId(R.id.propose_walk_time), withText("1:00"),
                        isDisplayed()));
        appCompatEditText8e2.perform(closeSoftKeyboard());

        ViewInteraction appCompatEditText9e2 = onView(
                allOf(withId(R.id.propose_walk_date), withText("Propose Date"),
                        isDisplayed()));
        appCompatEditText9e2.perform(replaceText("1/3/19"));

        ViewInteraction appCompatEditText10e2 = onView(
                allOf(withId(R.id.propose_walk_date), withText("1/3/19"),
                        isDisplayed()));
        appCompatEditText10e2.perform(closeSoftKeyboard());

        ViewInteraction appCompatButton7e2 = onView(
                allOf(withId(R.id.propose_walk_schedule_button),
                        isDisplayed()));
        appCompatButton7e2.perform(click());

        ViewInteraction appCompatButton7e23 = onView(
                allOf(withId(R.id.propose_walk_exit_button),
                        isDisplayed()));
        appCompatButton7e23.perform(click());

        ViewInteraction appCompatButton7e234 = onView(
                allOf(withId(R.id.proposed_walk_exit_button),
                        isDisplayed()));
        appCompatButton7e234.perform(click());

        ViewInteraction appCompatButton7e2344 = onView(
                allOf(withId(R.id.backToMainMenuButtonFromTeam),
                        isDisplayed()));
        appCompatButton7e2344.perform(click());

        ViewInteraction appCompatButton2qx = onView(
                allOf(withId(R.id.teamRoutesButton), withText("Team Routes"),
                        isDisplayed()));
        appCompatButton2qx.perform(click());

        ViewInteraction appCompatButton3qx = onView(
                allOf(withId(R.id.current_proposed_walk_button), withText("Current Proposed Walk"),
                        isDisplayed()));
        appCompatButton3qx.perform(click());

        pressBack();
        pressBack();
        pressBack();

        ViewInteraction appCompatButton100a = onView(
                allOf(withId(R.id.startWWRButton),
                        isDisplayed()));
        appCompatButton100a.perform(click());

        ViewInteraction appCompatButton2qxa = onView(
                allOf(withId(R.id.teamRoutesButton), withText("Team Routes"),
                        isDisplayed()));
        appCompatButton2qxa.perform(click());

        ViewInteraction appCompatButton3qxa = onView(
                allOf(withId(R.id.current_proposed_walk_button), withText("Current Proposed Walk"),
                        isDisplayed()));
        appCompatButton3qxa.perform(click());

        ViewInteraction appCompatRadioButtonqa = onView(
                allOf(withId(R.id.accept),
                        isDisplayed()));
        appCompatRadioButtonqa.perform(click());
